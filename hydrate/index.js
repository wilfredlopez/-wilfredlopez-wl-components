...
class WlSpinner {
    ...
    render() {
        ...
        return (h(Host, { "aria-hidden": this.isOpen ? "false" : "true", class: Object.assign({ "is-open": this.isOpen }, createColorClasses(this.color)) }, h("slot", { name: "button-open" }, h("wl-drawer-menu-button", { onClick: () => this.open() })), h("div", { id: "focus-guard" }), h("div", { class: "overlay-container" }, h("div", { class: "overlay", onClick: () => this.close() }, h("div", { class: "dialog", style: styles, onClick: (e) => {
                e.stopPropagation();
                e.preventDefault();
            } }, h("slot", null)))), h("div", { "data-focus-guard": this.isOpen, tabindex: "0", style: {
                width: "1px",
                height: "0px",
                padding: "0px",
                overflow: "hidden",
