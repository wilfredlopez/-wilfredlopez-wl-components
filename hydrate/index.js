...
class WlDrawer {
    ...
    render() {
        ...
        return (h(Host, { "aria-hidden": this.isOpen ? "false" : "true", class: Object.assign({ "is-open": this.isOpen }, createColorClasses(this.color)) }, h("slot", { name: "button-open" }, h("wl-drawer-menu-button", { onClick: () => this.open() })), h("div", { id: "focus-guard" }), h("div", { class: "overlay-container" }, h("div", { class: "overlay", onClick: (e) => {
                if (e.srcElement) {
            ...
            } }, h("div", { class: "dialog", style: styles }, h("slot", null)))), h("div", { "data-focus-guard": this.isOpen, tabindex: "0", style: {
                width: "1px",
                height: "0px",
                padding: "0px",
                overflow: "hidden",
...
class WlText {
    ...
    render() {
        return (h(Host, { class: Object.assign({}, createColorClasses(this.color)) }, h("slot", null)));
    }
