...
const appbarCss = "/*!@:host*/.sc-wl-appbar-h{--color:rgba(0, 0, 0, 0.87);--background-color:#fff}/*!@[color=primary]*/[color=primary].sc-wl-appbar{--background-color:var(--wl-color-primary, #3880ff);--color:var(--wl-color-primary-contrast, #fff)}/*!@[color=secondary]*/[color=secondary].sc-wl-appbar{--background-color:var(--wl-color-secondary, #3dc2ff);--color:var(--wl-color-secondary-contrast, #fff)}/*!@[color=tertiary]*/[color=tertiary].sc-wl-appbar{--background-color:var(--wl-color-tertiary, #5260ff);--color:var(--wl-color-tertiary-contrast, #fff)}/*!@[color=success]*/[color=success].sc-wl-appbar{--background-color:var(--wl-color-success, #2dd36f);--color:var(--wl-color-success-contrast, #fff)}/*!@[color=warning]*/[color=warning].sc-wl-appbar{--background-color:var(--wl-color-warning, #ffc409);--color:var(--wl-color-warning-contrast, #000)}/*!@[color=danger]*/[color=danger].sc-wl-appbar{--background-color:var(--wl-color-danger, #eb445a);--color:var(--wl-color-danger-contrast, #fff)}/*!@[color=light]*/[color=light].sc-wl-appbar{--background-color:var(--wl-color-light, #f4f5f8);--color:var(--wl-color-light-contrast, #000)}/*!@[color=medium]*/[color=medium].sc-wl-appbar{--background-color:var(--wl-color-medium, #92949c);--color:var(--wl-color-medium-contrast, #fff)}/*!@[color=dark]*/[color=dark].sc-wl-appbar{--background-color:var(--wl-color-dark, #222428);--color:var(--wl-color-dark-contrast, #fff)}/*!@:host*/.sc-wl-appbar-h{-ms-flex-positive:1;flex-grow:1}/*!@:host header*/.sc-wl-appbar-h header.sc-wl-appbar{color:var(--color, rgba(0, 0, 0, 0.87));background-color:var(--background-color, #fff);-webkit-transition:-webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:-webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, -webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;width:100%;display:-ms-flexbox;display:flex;z-index:1100;-webkit-box-sizing:border-box;box-sizing:border-box;-ms-flex-negative:0;flex-shrink:0;-ms-flex-direction:column;flex-direction:column;-webkit-box-shadow:0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);box-shadow:0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12)}/*!@:host [static]*/.sc-wl-appbar-h [static].sc-wl-appbar{position:static;-webkit-transform:translateZ(0);transform:translateZ(0)}/*!@:host [regular]*/.sc-wl-appbar-h [regular].sc-wl-appbar{min-height:56px}@media (min-width: 600px){/*!@:host [regular]*/.sc-wl-appbar-h [regular].sc-wl-appbar{min-height:64px}}/*!@:host #toolbar*/.sc-wl-appbar-h #toolbar.sc-wl-appbar{display:-ms-flexbox;display:flex;position:relative;-ms-flex-align:center;align-items:center;padding-left:16px;padding-right:16px}@media (min-width: 600px){/*!@:host #toolbar*/.sc-wl-appbar-h #toolbar.sc-wl-appbar{padding-left:24px;padding-right:24px}}";
...
class WlAppbar {
    ...
    render() {
        const { color } = this;
        return (h(Host, { color: color }, h("header", { color: color }, h("div", { id: "toolbar" }, h("slot", null)))));
    }
...
class WlButton {
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": undefined,
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": [["disabled", "disabled"], ["circular", "circular"], ["variant", "variant"], ["color", "color"], ["size", "size"]]
    }; }
}

const cardCss = "/*!@:host*/.sc-wl-card-h{width:100%}/*!@:host div*/.sc-wl-card-h div.sc-wl-card{-webkit-box-shadow:0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12);box-shadow:0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12);color:rgba(0, 0, 0, 0.87);-webkit-transition:-webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:-webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;transition:box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, -webkit-box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;background-color:#fff;overflow:hidden;border-radius:4px}/*!@::slotted([slot=header])*/.sc-wl-card-s>[slot=header]{display:-ms-flexbox;display:flex;margin:0;margin-bottom:1rem;-ms-flex-align:center;align-items:center}/*!@::slotted([slot=content])*/.sc-wl-card-s>[slot=content]{padding-top:0;padding-bottom:0}/*!@**/*.sc-wl-card{padding-top:0;padding-bottom:0;padding:16px}";
...
class WlContainer {
    ...
    render() {
        ...
        return (h(Host, { fluid: fluid, size: size }, h("div", { id: "wl-container",
            //@ts-ignore
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": undefined,
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": [["size", "size"], ["maxWidth", "max-width"], ["fluid", "fluid"]]
    }; }
}
...
const wlSpinnerCss = "/*!@[color=primary]*/[color=primary].sc-wl-spinner{--spinnerColor:var(--wl-color-primary, #3880ff)}/*!@[color=secondary]*/[color=secondary].sc-wl-spinner{--spinnerColor:var(--wl-color-secondary, #3dc2ff)}/*!@[color=tertiary]*/[color=tertiary].sc-wl-spinner{--spinnerColor:var(--wl-color-tertiary, #5260ff)}/*!@[color=success]*/[color=success].sc-wl-spinner{--spinnerColor:var(--wl-color-success, #2dd36f)}/*!@[color=warning]*/[color=warning].sc-wl-spinner{--spinnerColor:var(--wl-color-warning, #ffc409)}/*!@[color=danger]*/[color=danger].sc-wl-spinner{--spinnerColor:var(--wl-color-danger, #eb445a)}/*!@[color=light]*/[color=light].sc-wl-spinner{--spinnerColor:var(--wl-color-light, #f4f5f8)}/*!@[color=medium]*/[color=medium].sc-wl-spinner{--spinnerColor:var(--wl-color-medium, #92949c)}/*!@[color=dark]*/[color=dark].sc-wl-spinner{--spinnerColor:var(--wl-color-dark, #222428)}/*!@[variant=ellipsis]*/[variant=ellipsis].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ellipsis] div*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner{position:absolute;top:33px;width:13px;height:13px;border-radius:50%;background:var(--spinnerColor, #2457e6);-webkit-animation-timing-function:cubic-bezier(0, 1, 1, 0);animation-timing-function:cubic-bezier(0, 1, 1, 0)}/*!@[variant=ellipsis] div:nth-child(1)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(1){left:8px;-webkit-animation:lds-ellipsis1 0.6s infinite;animation:lds-ellipsis1 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(2)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(2){left:8px;-webkit-animation:lds-ellipsis2 0.6s infinite;animation:lds-ellipsis2 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(3)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(3){left:32px;-webkit-animation:lds-ellipsis2 0.6s infinite;animation:lds-ellipsis2 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(4)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(4){left:56px;-webkit-animation:lds-ellipsis3 0.6s infinite;animation:lds-ellipsis3 0.6s infinite}@-webkit-keyframes lds-ellipsis1{0%{-webkit-transform:scale(0);transform:scale(0)}100%{-webkit-transform:scale(1);transform:scale(1)}}@keyframes lds-ellipsis1{0%{-webkit-transform:scale(0);transform:scale(0)}100%{-webkit-transform:scale(1);transform:scale(1)}}@-webkit-keyframes lds-ellipsis3{0%{-webkit-transform:scale(1);transform:scale(1)}100%{-webkit-transform:scale(0);transform:scale(0)}}@keyframes lds-ellipsis3{0%{-webkit-transform:scale(1);transform:scale(1)}100%{-webkit-transform:scale(0);transform:scale(0)}}@-webkit-keyframes lds-ellipsis2{0%{-webkit-transform:translate(0, 0);transform:translate(0, 0)}100%{-webkit-transform:translate(24px, 0);transform:translate(24px, 0)}}@keyframes lds-ellipsis2{0%{-webkit-transform:translate(0, 0);transform:translate(0, 0)}100%{-webkit-transform:translate(24px, 0);transform:translate(24px, 0)}}/*!@[variant=ios]*/[variant=ios].sc-wl-spinner{color:official;display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ios] div*/[variant=ios].sc-wl-spinner div.sc-wl-spinner{-webkit-transform-origin:40px 40px;transform-origin:40px 40px;-webkit-animation:lds-spinner 1.2s linear infinite;animation:lds-spinner 1.2s linear infinite}/*!@[variant=ios] div:after*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:after{content:\" \";display:block;position:absolute;top:3px;left:37px;width:6px;height:18px;border-radius:20%;background:var(--spinnerColor, #2457e6)}/*!@[variant=ios] div:nth-child(1)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(1){-webkit-transform:rotate(0deg);transform:rotate(0deg);-webkit-animation-delay:-1.1s;animation-delay:-1.1s}/*!@[variant=ios] div:nth-child(2)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(2){-webkit-transform:rotate(30deg);transform:rotate(30deg);-webkit-animation-delay:-1s;animation-delay:-1s}/*!@[variant=ios] div:nth-child(3)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(3){-webkit-transform:rotate(60deg);transform:rotate(60deg);-webkit-animation-delay:-0.9s;animation-delay:-0.9s}/*!@[variant=ios] div:nth-child(4)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(4){-webkit-transform:rotate(90deg);transform:rotate(90deg);-webkit-animation-delay:-0.8s;animation-delay:-0.8s}/*!@[variant=ios] div:nth-child(5)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(5){-webkit-transform:rotate(120deg);transform:rotate(120deg);-webkit-animation-delay:-0.7s;animation-delay:-0.7s}/*!@[variant=ios] div:nth-child(6)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(6){-webkit-transform:rotate(150deg);transform:rotate(150deg);-webkit-animation-delay:-0.6s;animation-delay:-0.6s}/*!@[variant=ios] div:nth-child(7)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(7){-webkit-transform:rotate(180deg);transform:rotate(180deg);-webkit-animation-delay:-0.5s;animation-delay:-0.5s}/*!@[variant=ios] div:nth-child(8)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(8){-webkit-transform:rotate(210deg);transform:rotate(210deg);-webkit-animation-delay:-0.4s;animation-delay:-0.4s}/*!@[variant=ios] div:nth-child(9)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(9){-webkit-transform:rotate(240deg);transform:rotate(240deg);-webkit-animation-delay:-0.3s;animation-delay:-0.3s}/*!@[variant=ios] div:nth-child(10)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(10){-webkit-transform:rotate(270deg);transform:rotate(270deg);-webkit-animation-delay:-0.2s;animation-delay:-0.2s}/*!@[variant=ios] div:nth-child(11)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(11){-webkit-transform:rotate(300deg);transform:rotate(300deg);-webkit-animation-delay:-0.1s;animation-delay:-0.1s}/*!@[variant=ios] div:nth-child(12)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(12){-webkit-transform:rotate(330deg);transform:rotate(330deg);-webkit-animation-delay:0s;animation-delay:0s}@-webkit-keyframes lds-spinner{0%{opacity:1}100%{opacity:0}}@keyframes lds-spinner{0%{opacity:1}100%{opacity:0}}/*!@[variant=facebook]*/[variant=facebook].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=facebook] div*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner{display:inline-block;position:absolute;left:8px;width:16px;background:var(--spinnerColor, #2457e6);-webkit-animation:lds-facebook 1.2s cubic-bezier(0, 0.5, 0.5, 1) infinite;animation:lds-facebook 1.2s cubic-bezier(0, 0.5, 0.5, 1) infinite}/*!@[variant=facebook] div:nth-child(1)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(1){left:8px;-webkit-animation-delay:-0.24s;animation-delay:-0.24s}/*!@[variant=facebook] div:nth-child(2)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(2){left:32px;-webkit-animation-delay:-0.12s;animation-delay:-0.12s}/*!@[variant=facebook] div:nth-child(3)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(3){left:56px;-webkit-animation-delay:0;animation-delay:0}@-webkit-keyframes lds-facebook{0%{top:8px;height:64px}50%,100%{top:24px;height:32px}}@keyframes lds-facebook{0%{top:8px;height:64px}50%,100%{top:24px;height:32px}}/*!@[variant=ring]*/[variant=ring].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ring] div*/[variant=ring].sc-wl-spinner div.sc-wl-spinner{-webkit-box-sizing:border-box;box-sizing:border-box;display:block;position:absolute;width:64px;height:64px;margin:8px;border:8px solid white;border-radius:50%;-webkit-animation:lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;animation:lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;border-color:var(--spinnerColor, #2457e6) transparent transparent transparent}/*!@[variant=ring] div:nth-child(1)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(1){-webkit-animation-delay:-0.45s;animation-delay:-0.45s}/*!@[variant=ring] div:nth-child(2)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(2){-webkit-animation-delay:-0.3s;animation-delay:-0.3s}/*!@[variant=ring] div:nth-child(3)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(3){-webkit-animation-delay:-0.15s;animation-delay:-0.15s}@-webkit-keyframes lds-ring{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes lds-ring{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}/*!@[variant=ripple]*/[variant=ripple].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ripple] div*/[variant=ripple].sc-wl-spinner div.sc-wl-spinner{position:absolute;border:4px solid var(--spinnerColor, #2457e6);opacity:1;border-radius:50%;-webkit-animation:lds-ripple 1s cubic-bezier(0, 0.2, 0.8, 1) infinite;animation:lds-ripple 1s cubic-bezier(0, 0.2, 0.8, 1) infinite}/*!@[variant=ripple] div:nth-child(2)*/[variant=ripple].sc-wl-spinner div.sc-wl-spinner:nth-child(2){-webkit-animation-delay:-0.5s;animation-delay:-0.5s}@-webkit-keyframes lds-ripple{0%{top:36px;left:36px;width:0;height:0;opacity:1}100%{top:0px;left:0px;width:72px;height:72px;opacity:0}}@keyframes lds-ripple{0%{top:36px;left:36px;width:0;height:0;opacity:1}100%{top:0px;left:0px;width:72px;height:72px;opacity:0}}/*!@[variant=loader]*/[variant=loader].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=loader] div*/[variant=loader].sc-wl-spinner div.sc-wl-spinner{-webkit-animation:lds-roller 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;animation:lds-roller 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;-webkit-transform-origin:40px 40px;transform-origin:40px 40px}/*!@[variant=loader] div:after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:after{content:\" \";display:block;position:absolute;width:7px;height:7px;border-radius:50%;background:var(--spinnerColor, blue);margin:-4px 0 0 -4px}/*!@[variant=loader] div:nth-child(1)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(1){-webkit-animation-delay:-0.036s;animation-delay:-0.036s}/*!@[variant=loader] div:nth-child(1):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(1):after{top:63px;left:63px}/*!@[variant=loader] div:nth-child(2)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(2){-webkit-animation-delay:-0.072s;animation-delay:-0.072s}/*!@[variant=loader] div:nth-child(2):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(2):after{top:68px;left:56px}/*!@[variant=loader] div:nth-child(3)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(3){-webkit-animation-delay:-0.108s;animation-delay:-0.108s}/*!@[variant=loader] div:nth-child(3):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(3):after{top:71px;left:48px}/*!@[variant=loader] div:nth-child(4)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(4){-webkit-animation-delay:-0.144s;animation-delay:-0.144s}/*!@[variant=loader] div:nth-child(4):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(4):after{top:72px;left:40px}/*!@[variant=loader] div:nth-child(5)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(5){-webkit-animation-delay:-0.18s;animation-delay:-0.18s}/*!@[variant=loader] div:nth-child(5):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(5):after{top:71px;left:32px}/*!@[variant=loader] div:nth-child(6)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(6){-webkit-animation-delay:-0.216s;animation-delay:-0.216s}/*!@[variant=loader] div:nth-child(6):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(6):after{top:68px;left:24px}/*!@[variant=loader] div:nth-child(7)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(7){-webkit-animation-delay:-0.252s;animation-delay:-0.252s}/*!@[variant=loader] div:nth-child(7):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(7):after{top:63px;left:17px}/*!@[variant=loader] div:nth-child(8)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(8){-webkit-animation-delay:-0.288s;animation-delay:-0.288s}/*!@[variant=loader] div:nth-child(8):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(8):after{top:56px;left:12px}@-webkit-keyframes lds-roller{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes lds-roller{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}";
...
class WlSpinner {
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": undefined,
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": [["variant", "variant"], ["color", "color"]]
    }; }
}
