...
const cardCss = "/*!@:host*/.sc-wl-card-h{width:100%}/*!@:host div*/.sc-wl-card-h div.sc-wl-card{box-shadow:0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12);color:rgba(0, 0, 0, 0.87);transition:box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;background-color:#fff;overflow:hidden;border-radius:4px}/*!@::slotted([slot=header])*/.sc-wl-card-s>[slot=header]{display:flex;margin:0;margin-bottom:1rem;align-items:center}/*!@::slotted([slot=content])*/.sc-wl-card-s>[slot=content]{padding-top:0;padding-bottom:0}/*!@**/*.sc-wl-card{padding-top:0;padding-bottom:0;padding:16px}";
