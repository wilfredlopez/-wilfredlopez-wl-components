...
const wlSpinnerCss = "/*!@[color=primary]*/[color=primary].sc-wl-spinner{--spinnerColor:var(--wl-color-primary, #3880ff)}/*!@[color=secondary]*/[color=secondary].sc-wl-spinner{--spinnerColor:var(--wl-color-secondary, #3dc2ff)}/*!@[color=tertiary]*/[color=tertiary].sc-wl-spinner{--spinnerColor:var(--wl-color-tertiary, #5260ff)}/*!@[color=success]*/[color=success].sc-wl-spinner{--spinnerColor:var(--wl-color-success, #2dd36f)}/*!@[color=warning]*/[color=warning].sc-wl-spinner{--spinnerColor:var(--wl-color-warning, #ffc409)}/*!@[color=danger]*/[color=danger].sc-wl-spinner{--spinnerColor:var(--wl-color-danger, #eb445a)}/*!@[color=light]*/[color=light].sc-wl-spinner{--spinnerColor:var(--wl-color-light, #f4f5f8)}/*!@[color=medium]*/[color=medium].sc-wl-spinner{--spinnerColor:var(--wl-color-medium, #92949c)}/*!@[color=dark]*/[color=dark].sc-wl-spinner{--spinnerColor:var(--wl-color-dark, #222428)}/*!@[variant=ellipsis]*/[variant=ellipsis].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ellipsis] div*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner{position:absolute;top:33px;width:13px;height:13px;border-radius:50%;background:var(--spinnerColor, #2457e6);animation-timing-function:cubic-bezier(0, 1, 1, 0)}/*!@[variant=ellipsis] div:nth-child(1)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(1){left:8px;animation:lds-ellipsis1 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(2)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(2){left:8px;animation:lds-ellipsis2 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(3)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(3){left:32px;animation:lds-ellipsis2 0.6s infinite}/*!@[variant=ellipsis] div:nth-child(4)*/[variant=ellipsis].sc-wl-spinner div.sc-wl-spinner:nth-child(4){left:56px;animation:lds-ellipsis3 0.6s infinite}@keyframes lds-ellipsis1{0%{transform:scale(0)}100%{transform:scale(1)}}@keyframes lds-ellipsis3{0%{transform:scale(1)}100%{transform:scale(0)}}@keyframes lds-ellipsis2{0%{transform:translate(0, 0)}100%{transform:translate(24px, 0)}}/*!@[variant=ios]*/[variant=ios].sc-wl-spinner{color:official;display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ios] div*/[variant=ios].sc-wl-spinner div.sc-wl-spinner{transform-origin:40px 40px;animation:lds-spinner 1.2s linear infinite}/*!@[variant=ios] div:after*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:after{content:\" \";display:block;position:absolute;top:3px;left:37px;width:6px;height:18px;border-radius:20%;background:var(--spinnerColor, #2457e6)}/*!@[variant=ios] div:nth-child(1)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(1){transform:rotate(0deg);animation-delay:-1.1s}/*!@[variant=ios] div:nth-child(2)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(2){transform:rotate(30deg);animation-delay:-1s}/*!@[variant=ios] div:nth-child(3)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(3){transform:rotate(60deg);animation-delay:-0.9s}/*!@[variant=ios] div:nth-child(4)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(4){transform:rotate(90deg);animation-delay:-0.8s}/*!@[variant=ios] div:nth-child(5)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(5){transform:rotate(120deg);animation-delay:-0.7s}/*!@[variant=ios] div:nth-child(6)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(6){transform:rotate(150deg);animation-delay:-0.6s}/*!@[variant=ios] div:nth-child(7)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(7){transform:rotate(180deg);animation-delay:-0.5s}/*!@[variant=ios] div:nth-child(8)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(8){transform:rotate(210deg);animation-delay:-0.4s}/*!@[variant=ios] div:nth-child(9)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(9){transform:rotate(240deg);animation-delay:-0.3s}/*!@[variant=ios] div:nth-child(10)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(10){transform:rotate(270deg);animation-delay:-0.2s}/*!@[variant=ios] div:nth-child(11)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(11){transform:rotate(300deg);animation-delay:-0.1s}/*!@[variant=ios] div:nth-child(12)*/[variant=ios].sc-wl-spinner div.sc-wl-spinner:nth-child(12){transform:rotate(330deg);animation-delay:0s}@keyframes lds-spinner{0%{opacity:1}100%{opacity:0}}/*!@[variant=facebook]*/[variant=facebook].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=facebook] div*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner{display:inline-block;position:absolute;left:8px;width:16px;background:var(--spinnerColor, #2457e6);animation:lds-facebook 1.2s cubic-bezier(0, 0.5, 0.5, 1) infinite}/*!@[variant=facebook] div:nth-child(1)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(1){left:8px;animation-delay:-0.24s}/*!@[variant=facebook] div:nth-child(2)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(2){left:32px;animation-delay:-0.12s}/*!@[variant=facebook] div:nth-child(3)*/[variant=facebook].sc-wl-spinner div.sc-wl-spinner:nth-child(3){left:56px;animation-delay:0}@keyframes lds-facebook{0%{top:8px;height:64px}50%,100%{top:24px;height:32px}}/*!@[variant=ring]*/[variant=ring].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ring] div*/[variant=ring].sc-wl-spinner div.sc-wl-spinner{box-sizing:border-box;display:block;position:absolute;width:64px;height:64px;margin:8px;border:8px solid white;border-radius:50%;animation:lds-ring 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;border-color:var(--spinnerColor, #2457e6) transparent transparent transparent}/*!@[variant=ring] div:nth-child(1)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(1){animation-delay:-0.45s}/*!@[variant=ring] div:nth-child(2)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(2){animation-delay:-0.3s}/*!@[variant=ring] div:nth-child(3)*/[variant=ring].sc-wl-spinner div.sc-wl-spinner:nth-child(3){animation-delay:-0.15s}@keyframes lds-ring{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}/*!@[variant=ripple]*/[variant=ripple].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=ripple] div*/[variant=ripple].sc-wl-spinner div.sc-wl-spinner{position:absolute;border:4px solid var(--spinnerColor, #2457e6);opacity:1;border-radius:50%;animation:lds-ripple 1s cubic-bezier(0, 0.2, 0.8, 1) infinite}/*!@[variant=ripple] div:nth-child(2)*/[variant=ripple].sc-wl-spinner div.sc-wl-spinner:nth-child(2){animation-delay:-0.5s}@keyframes lds-ripple{0%{top:36px;left:36px;width:0;height:0;opacity:1}100%{top:0px;left:0px;width:72px;height:72px;opacity:0}}/*!@[variant=loader]*/[variant=loader].sc-wl-spinner{display:inline-block;position:relative;width:80px;height:80px}/*!@[variant=loader] div*/[variant=loader].sc-wl-spinner div.sc-wl-spinner{animation:lds-roller 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;transform-origin:40px 40px}/*!@[variant=loader] div:after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:after{content:\" \";display:block;position:absolute;width:7px;height:7px;border-radius:50%;background:var(--spinnerColor, blue);margin:-4px 0 0 -4px}/*!@[variant=loader] div:nth-child(1)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(1){animation-delay:-0.036s}/*!@[variant=loader] div:nth-child(1):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(1):after{top:63px;left:63px}/*!@[variant=loader] div:nth-child(2)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(2){animation-delay:-0.072s}/*!@[variant=loader] div:nth-child(2):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(2):after{top:68px;left:56px}/*!@[variant=loader] div:nth-child(3)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(3){animation-delay:-0.108s}/*!@[variant=loader] div:nth-child(3):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(3):after{top:71px;left:48px}/*!@[variant=loader] div:nth-child(4)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(4){animation-delay:-0.144s}/*!@[variant=loader] div:nth-child(4):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(4):after{top:72px;left:40px}/*!@[variant=loader] div:nth-child(5)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(5){animation-delay:-0.18s}/*!@[variant=loader] div:nth-child(5):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(5):after{top:71px;left:32px}/*!@[variant=loader] div:nth-child(6)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(6){animation-delay:-0.216s}/*!@[variant=loader] div:nth-child(6):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(6):after{top:68px;left:24px}/*!@[variant=loader] div:nth-child(7)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(7){animation-delay:-0.252s}/*!@[variant=loader] div:nth-child(7):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(7):after{top:63px;left:17px}/*!@[variant=loader] div:nth-child(8)*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(8){animation-delay:-0.288s}/*!@[variant=loader] div:nth-child(8):after*/[variant=loader].sc-wl-spinner div.sc-wl-spinner:nth-child(8):after{top:56px;left:12px}@keyframes lds-roller{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}";
