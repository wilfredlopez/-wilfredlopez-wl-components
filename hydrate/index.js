...
class WlDrawerCloseButton {
  ...
  render() {
    ...
    return (hAsync(Host, { color: this.color, variant: this.variant, class: {
...
class WlDrawerMenuButton {
  ...
  render() {
    ...
    return (hAsync(Host, { size: size, color: color, variant: variant }, hAsync("wl-button", { onClick: (e) => this.onClick(e), size: size, color: color, variant: variant }, hAsync("span", { class: "label" }, hAsync("svg", { class: "svg-icon", focusable: "false", viewBox: "0 0 24 24", "aria-hidden": "true" }, hAsync("path", { d: "M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" }))), hAsync("span", { class: "root" }, hAsync("slot", null)))));
  }
  get el() { return getElement(this); }
...
class WlModal {
  ...
  render() {
    return [
      ...
      hAsync("div", { id: "modal" }, hAsync("header", null, hAsync("slot", { name: "title" }, hAsync("h1", null, "Title"))), hAsync("div", { id: "content" }, hAsync("slot", null)), hAsync("div", { id: "actions" }, hAsync("div", { id: "action-data" }, hAsync("slot", { name: "actions" })))),
    ];
  }
...
class WlRow {
  ...
  render() {
    return (hAsync(Host, { align: this.align }, hAsync("slot", null)));
  }
